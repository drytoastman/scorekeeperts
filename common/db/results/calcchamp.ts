...
import { hasFinished, SeriesEvent } from '@sctypes/event'
import { ChampEntrant, ChampResults, Entrant } from '@sctypes/results'
import { getD, getDList, getDObj } from '@sctypes/data'
