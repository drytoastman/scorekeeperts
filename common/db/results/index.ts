...
import { SeriesInfo, SeriesStatus } from '@sctypes/series'
import { updatedSeriesInfo, updatedEventResults } from './calc'
import { ChampResults, EventResults, Run } from '@sctypes/results'
...
import { ChallengeResults } from '@sctypes/challenge'
